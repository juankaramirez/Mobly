...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;

-- Volcando datos para la tabla mobly.order: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
INSERT INTO `order` (`order_id`, `user_id`, `date`) VALUES
	(34, 1, '2014-04-21 05:25:46'),
	(36, 1, '2014-05-30 05:00:45'),
	(37, 2, '2014-05-30 05:01:28'),
	(38, 5, '2014-05-30 05:07:08');
...
INSERT INTO `user` (`user_id`, `username`, `password`, `name`, `lastname`, `email`, `address`) VALUES
	...
	(5, 'cityuser', 'citycity', 'Holi', 'Como', 'Estas@Bien.com', 'alksahsfa');
